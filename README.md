...
- 双 Worktree 隔离 + 路径穿越防御 (realpath + symlink 检测)
- L1/L2/L3 智能分级 + Jaccard 预测准确率 + DAG 失败传播
...
```
packages/
├── shared/        共享类型、常量、错误类、HMAC 工具、OTel 辅助
├── validate/      写保护、路径穿越防御
...
└── scheduler/     调度主循环、F1-β 追踪、审计日志、成本控制
```
